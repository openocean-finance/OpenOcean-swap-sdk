...
export class ReqBase {
  ...
  @IsIn(chainsObj.chainIds, { message: 'Chain id in(31/56/100/137/250/42161/43114)' })
  @Type(() => String)
...
export class ChainName {
  ...
  @IsIn(chainsObj.chainNames, { message: `Chain in(${chainsObj.chainNames.join(',')})` })
  @Type(() => String)
  public chain: string
