    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    contract = null;
                    if (!(chainName === 'ont' || chainName === 'solana' || chainName === 'osmosis')) return [3 /*break*/, 1];
                    return [2 /*return*/, '-1'];
                case 1:
                ...
                case 6:
                    ...
                    return [2 /*return*/, '-1'];
                case 7:
                    console.log('chainsObj.isNativeToken', wallet_1.chainsObj.isNativeToken(chainName, tokenAddress), chainName, tokenAddress);
                    if (!wallet_1.chainsObj.isNativeToken(chainName, tokenAddress)) return [3 /*break*/, 8];
                    return [2 /*return*/, '-1'];
                case 8:
